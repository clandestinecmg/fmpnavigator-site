...
const posts: Post[] = [
  {
    ...
    date: "2025-10-18",
    summary:
      "What we’re building for U.S. Veterans overseas and how to get involved.",
  },
  {
    ...
    date: "2025-10-18",
    summary:
      "How we’re mapping direct-billing facilities across SEA and validating entries.",
  },
];
  ...
  return (
    <section className="container py-16">
      ...
      <p className="mt-2 muted">
        News and progress on providers, policy, and the app.
      </p>
      ...
      <div className="mt-8 grid gap-4">
        {posts.map((p) => (
          <Link
            key={p.slug}
            href={`/updates/${p.slug}`}
            className="card hover:border-(--accent)/60 transition block"
          ...
          >
            ...
            <p className="mt-1 text-sm text-(--muted-2)">{p.summary}</p>
          </Link>
        ))}
      </div>
    </section>
